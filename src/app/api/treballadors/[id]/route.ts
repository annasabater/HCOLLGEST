  ...
  try {
    ...
    const treballador = await prisma.treballador.update({
      ...
      data: {
        ...
        ...(data.preuSortida !== undefined && { preuSortida: data.preuSortida ?? null }),
        ...(data.preuManteniment !== undefined && { preuManteniment: data.preuManteniment ?? null }),
        ...(data.preuZones !== undefined && { preuZones: data.preuZones ?? null }),
